...
#define PosSamListFile "D:\\work\\git\\Pedestrian_Detection\\INRIAPerson96X160PosList.txt" //正样本图片的文件名列表
#define NegSamListFile "D:\\work\\git\\Pedestrian_Detection\\NoPersonFromINRIAList.txt" //负样本图片的文件名列表
...
#define TestImageFileName "D:\\work\\git\\Pedestrian_Detection\\Test.jpg"  //训练完成后读入一张图片来测试效果
